...
import com.example.date_time_aufgabe.Model.getDate2
import com.example.date_time_aufgabe.Model.getSeconds2
import com.example.date_time_aufgabe.Model.getTime2
...
fun DateTimePicker2() {
    ...
    val datePicker = DatePickerDialog(
        ...
        { _: DatePicker, selectedYear: Int, selectedMonth: Int, selectedDayOfMonth: Int ->
            ...
            getDate2(selectedYear,selectedMonth,selectedDayOfMonth)
    ...
    val timePicker = TimePickerDialog(
        ...
        { _, selectedHour: Int, selectedMinute: Int ->
            ...
            getTime2(selectedHour,selectedMinute)
